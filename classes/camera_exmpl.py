...
class Tree(pygame.sprite.Sprite):
	def __init__(self,pos,group):
		...
		self.image = pygame.image.load('images/Enemies/Spaceship1/ship1-1.png').convert_alpha()
		self.rect = self.image.get_rect(topleft = pos)

class Player(pygame.sprite.Sprite):
	def __init__(self,pos,group):
		super().__init__(group)
		self.image = pygame.image.load('images/Heroes/Spaceship1/ship1-1.png').convert_alpha()
...
class CameraGroup(pygame.sprite.Group):
	def __init__(self):
		...
		# ground
		self.ground_surf = pygame.image.load('images/back6.jpg').convert_alpha()
