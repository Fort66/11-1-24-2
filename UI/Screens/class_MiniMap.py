...
class MiniMap:
    ...
    def set_map(self):
        ...
        self.ratioX = (
            self.map_size[0] / self.spite_groups.camera_group.background_rect[2]
        )
        self.ratioY = (
            self.map_size[1] / self.spite_groups.camera_group.background_rect[3]
        )
    ...
    def draw_player(self):
        for player in self.spite_groups.player_group:
            pg.draw.circle(
                self.map_surface,
                "yellow",
                (
    ...
    def draw_enemies(self):
        for enemy in self.spite_groups.enemies_group:
            pg.draw.circle(
                self.map_surface,
                "red",
                (
    ...
    def draw_player_shot(self):
        for shot in self.spite_groups.player_shot_group:
            pg.draw.circle(
                self.map_surface,
                "lime",
                (
    ...
    def draw_enemies_shot(self):
        for shot in self.spite_groups.enemies_shot_group:
            pg.draw.circle(
                self.map_surface,
                "Aqua",
                (
